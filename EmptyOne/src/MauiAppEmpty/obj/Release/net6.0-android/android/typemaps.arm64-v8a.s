...
map_modules:
	...
	.byte	0x15, 0x98, 0xe1, 0xe6, 0x4b, 0xb9, 0x27, 0x49, 0xb6, 0xbb, 0x3d, 0xf4, 0x60, 0x93, 0x64, 0xbb	// module_uuid: e6e19815-b94b-4927-b6bb-3df4609364bb
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module1_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.1	// assembly_name: MauiAppEmpty
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
	...
	.byte	0x5a, 0xbe, 0xbb, 0x21, 0xbc, 0x37, 0x36, 0x4b, 0xb5, 0x89, 0xdf, 0xe6, 0xe7, 0x26, 0xfc, 0xf3	// module_uuid: 21bbbe5a-37bc-4b36-b589-dfe6e726fcf3
	.word	0x3	// entry_count
	.word	0x0	// duplicate_count
...
map_java:
	...
	.word	0x200000c	// type_token_id
	.ascii	"crc6471ecdc0e53cd6072/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x1	// module_index
	.word	0x200000d	// type_token_id
	.ascii	"crc6471ecdc0e53cd6072/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
